...
def registrar_bitacora():
    ...
    mensaje_falla = input("Ingrese el mensaje de falla (Máximo 30 carácteres): ")
    nombre_responsable = input("Ingrese el nombre del responsable: ")
...
def exportar_bitacoras():
    ...
    print("Bitácoras exportadas exitosamente.")
